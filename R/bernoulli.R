...
#'   \code{NULL}).
#' @details
#' \code{fitBernoulli}: fit a Bernoulli distribution
#'
#' \code{logLikVector.bernoulli}: calculates contributions to a log-likelihood
#' based on the Bernoulli distribution.  The log-likelihood is calculated up to
...
#'
#' \code{logLikVector.bernoulli} returns an object of class \code{"logLikVector"}, a
