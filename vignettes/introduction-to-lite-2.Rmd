...
For information about the model underlying the inferences performed in this vignette, including the adjusted likelihood for $(p_u, \sigma_u, \xi)$ and the Cheeseboro wind gusts dataset used below, see the [Introducing lite](introduction-to-lite.html) vignette. 
...
See the [Posterior predictive extreme value inference](https://cran.r-project.org/web/packages/revdbayes/vignettes/revdbayes-c-predictive-vignette.html#posterior-predictive-extreme-value-inference) section of the  
